...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    area_of_interest: Schema.Attribute.JSON;
...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    drupal_nid: Schema.Attribute.Integer;
    drupal_path_alias: Schema.Attribute.String;
    drupal_uuid: Schema.Attribute.String;
...
export interface ApiChangeLogChangeLog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'version_name'> &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    time_of_release: Schema.Attribute.DateTime & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    version_name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
  };
}

export interface ApiDocumentationPageDocumentationPage
  extends Struct.CollectionTypeSchema {
  collectionName: 'documentation_pages';
  info: {
    description: '';
    displayName: 'Documentation Page';
    pluralName: 'documentation-pages';
    singularName: 'documentation-page';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiLayoutLayout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    footer_subtitle: Schema.Attribute.RichText;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::layout.layout'
    ...
    menu: Schema.Attribute.DynamicZone<
      ['navigation.menu-dropdown', 'navigation.menu-item']
    >;
    notification: Schema.Attribute.RichText;
    publishedAt: Schema.Attribute.DateTime;
    social_media_links: Schema.Attribute.Component<
      'blocks.social-media-icon',
      true
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
  ...
  attributes: {
    ...
    sections: Schema.Attribute.DynamicZone<
      [
        ...
        'sections.brand-section',
        'sections.video-section',
        'sections.review-section',
        'sections.pricing-section',
        'sections.featured-posts-section',
        ...
        'sections.all-posts-section',
        'sections.documentation-home',
        'sections.app-cta',
      ]
    > &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiPricingTierPricingTier extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    monthly_price: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    plan_features: Schema.Attribute.JSON;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'tier_name'> &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    tier_description: Schema.Attribute.RichText & Schema.Attribute.Required;
    tier_name: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    yearly_price: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
...
export interface ApiTestimonialTestimonial extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    reviewer_picture: Schema.Attribute.Media<'images'> &
      Schema.Attribute.Required;
    reviewer_title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::documentation-page.documentation-page': ApiDocumentationPageDocumentationPage;
